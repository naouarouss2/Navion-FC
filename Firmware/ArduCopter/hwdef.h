...
#define CHIBIOS_BOARD_NAME "Navion_FC"
...
#define STORAGE_FLASH_START_PAGE 14
#ifndef AP_CRASHDUMP_ENABLED
#define AP_CRASHDUMP_ENABLED 0
#endif
#define FLASH_BOOTLOADER_LOAD_KB 128
#define FLASH_RESERVE_END_KB 256
#define APP_START_OFFSET_KB 0

#define HAL_RAM0_START 0x20000000
// memory regions
#define HAL_MEMORY_REGIONS {(void*)0x20000000, 0x00020000, 0x02 }, {(void*)0x30000000, 0x00040000, 0x08 }, {(void*)0x24000000, 0x00080000, 0x04 }, {(void*)0x00000400, 0x0000fc00, 0x02 }, {(void*)0x30040000, 0x00008000, 0x08 }, {(void*)0x38000000, 0x00010000, 0x01 }
#define HAL_CC_MEMORY_REGIONS {0x20000000, 0x20020000, CRASH_CATCHER_BYTE }, {0x30000000, 0x30040000, CRASH_CATCHER_BYTE }, {0x24000000, 0x24080000, CRASH_CATCHER_BYTE }, {0x00000400, 0x00010000, CRASH_CATCHER_BYTE }, {0x30040000, 0x30048000, CRASH_CATCHER_BYTE }, {0x38000000, 0x38010000, CRASH_CATCHER_BYTE }
...
#define HAL_GPIO_PIN_MPU_CS               PAL_LINE(GPIOE,8U)
